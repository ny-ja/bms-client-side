          ...
          <div className="flex items-center">
            <div className="flex items-center ms-3">
              ...
              <div
                ...
                } absolute mt-2 mr-2 py-2 w-48 bg-white rounded-md shadow-lg dark:bg-gray-700`}
                ...
                <ul class="py-1" role="none">
                  <li>
                    <button
                      ...
                      class="w-full text-left rounded-lg block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
                      role="menuitem"
                    >
                      Logout
                    </button>
